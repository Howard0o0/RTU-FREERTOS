...
#define TraceMsg(_str,ln) \
    TraceMsgFuncLine(_str,ln,__FUNCTION__,__LINE__)
    
#define TraceStr(_str, _len, _ln) \
    TraceStrFuncLine(_str,_len,_ln, __FUNCTION__,__LINE__) 
