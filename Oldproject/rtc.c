...
int RTC_ReadCheckTimeBytes(unsigned char index, char* dest) {
	DownInt();
	if (RTC_IsBadTime(s_RTC_CheckTime, 0) == 0) {  //�ڴ�ֵ����ȷ��.
		...
		if (RTC_IsBadTime(dest, 0) == 0) {  // RTC����ȷ��.
...
int RTC_ReadSaveTimeBytes(unsigned char index, char* dest) {
	DownInt();
	if (RTC_IsBadTime(s_RTC_SaveTime, 0) == 0) {  //�ڴ�ֵ����ȷ��.
...
int RTC_ReadReportTimeBytes(unsigned char index, char* dest) {
	DownInt();
	if (RTC_IsBadTime(s_RTC_ReportTime, 0) == 0) {  //�ڴ�ֵ����ȷ��.
...
int RTC_ReadPulseBytes(int _index, char* _dest) {
	...
	if (s_RTC_PulseBytes[ _index - 1 ][ 0 ] == 0xFF
	    ...
	    && s_RTC_PulseBytes[ _index - 1 ][ 2 ] == 0xFF) {  //�ڴ�ֵ����
...
//
int RTC_IncPulseBytes(int _index) {  // �˺��� ���ж��е���,
				     // ( ����ִ��ҪѸ��  , �п����Ż�)
...
int RTC_IsBadTime(char* time, int isTime) {  //�޴�����0,���򷵻�-1.
					     //�ж�ԭ��
					     //  ������ݱ���Ҫ���ڵ���09��
					     //  ��ݱ���С��20��,
					     //  130C020F30
	...
	if (s_RTC_lastTime[ 0 ] >= 9 && s_RTC_lastTime[ 1 ] <= 12 && s_RTC_lastTime[ 1 ] >= 1
		...
		if (time[ 0 ] != s_RTC_lastTime[ 0 ]
		    && time[ 0 ] != s_RTC_lastTime[ 0 ] + 1) {  //����Ϊ���� Ҳ��Ϊȥ��.��ô���Ǹ�����
			return -1;
		}
		...
		if (time[ 1 ] != s_RTC_lastTime[ 1 ]
		    && time[ 1 ] != s_RTC_lastTime[ 1 ] + 1) {  //����Ϊ����,Ҳ��Ϊǰһ����,
			//����Ϊ1�µ����,����ǰһ����Ϊ12��
			//�����²�Ϊ1��, Ϊ1��ʱ,last��Ϊ12.
			if (time[ 1 ] != 1) {
				return -1;
...
int _RTC_SetTime(const char second, const char minute, const char hour, const char date,
		 ...
		 const char control)  //����99��12��31�� ����7 23��59��00��
{
	//  char second1=second;
	//  char minute1=minute;
	//  char hour1=hour;
