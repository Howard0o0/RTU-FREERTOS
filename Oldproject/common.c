...
{ 
    ...
    Hydrology_ReadStoreInfo(HYDROLOGY_SAMPLE_INTERVAL,&timerinterval,HYDROLOGY_SAMPLE_INTERVAL_LEN);  //ly
...
{    char timerinterval;
    char endtime[6] = {0,0,0,0,0,0};
    Hydrology_ReadStoreInfo(HYDROLOGY_WATERLEVEL_STORE_INTERVAL,&timerinterval,HYDROLOGY_WATERLEVEL_STORE_INTERVAL_LEN);  //ly
    timerinterval = _BCDtoDEC(timerinterval);
    Utility_Strncpy(endtime,_time,6);
