...
int converToHexElement(double input, int D,int d,char* out)
{
  ...
  if ( evenD >= total ) 				//���������ò�����֤
  {
    ...
    if( d >= decimer ) 					//����ǿ϶������ģ�getBCDnums��֤
    {
      ...
      diffInterger = difftotal - diffDecimer;//����λ��Ҫ��0 ��λ��,����difftotal���Ǵ���diffDecimer����ǰ��0
    }
    /*����ǰС��λ������λ�����ϵ�tmp�����У���Ϊ���漸������ 0--->diffInterger-1 ������0�ĸ�����diffInterger---> diffInterger+ interger������λ������
    diffInter+ interge ---> evenD��С��λ����*/
...
int hydrologyMakeDownBody(char* input,int len,int position)
{
  ...
  while(len != 0)
  {
    ...
    if(input[position]==0xFF)       //*********��չ��ʶ����FFxxxx���������ֽ�xx��ʾ��ʲôҪ�أ�xx��ʾ�������data���ȣ���5λ��ʾ�ֽ���������λ��ʾС�����λ��****************
    {
          position += 1;
          Extend_Flag = 1;
          len -= 1;
...
int hydrologyProcessReceieve(char* input,int inputlen)
{
  ...
  if(hydrologyMakeDownHeader(input,inputlen,&i,&bodylen) != 0)     //i��postion  ��bodylen���������ĳ���
    return -1;
